package tech.konso.toolsmanagement.modules.persons.business.role.controller;
...
public class RoleController {
    ...
    public RoleFilterResponse findAll(@RequestParam(value = "page") @Min(1) int page,
        ...
        Page<Role> roles = service.findAll(page - 1, size, specBuilder(isArchivedSpec(isArchived)
                .and(likeSpec(name))
                .and(sortSpec(sort)))
                .build());
