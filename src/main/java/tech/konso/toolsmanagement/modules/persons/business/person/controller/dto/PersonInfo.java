...
/**
 * Person info DTO class for get info by id API
 *
 * @param id             person id
 ...
 * @param labels         set of labels short descriptions
 * @param roles          set of roles short descriptions
 * @param createdAt      create date
 * @param updatedAt      update date
 */

@Builder
@Schema(description = "Person full information")
public record PersonInfo(@Schema(description = "person id", example = "1")
                         Long id,
                         ...
                         @Schema(description = "roles short descriptions", example = "[{id: 1, name:\"Admin\"},{id: 2, name:\"SuperUser\"}]")
                         Set<RoleShort> roles,
