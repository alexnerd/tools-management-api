...
/**
 * Stock info DTO class for {@link StockFilterResponse}
 * used in response for find stocks by parameters
 *
 * @param id          stock id
...
public record StockFilterInfo(@Schema(description = "stock id", example = "1")
                              Long id,
