...
public class LabelController {
    ...
    public LabelFilterResponse findAll(@RequestParam(value = "page") @Min(1) int page,
        ...
        Page<Label> labels = service.findAll(page - 1, size, AbstractSpecification.specBuilder(LabelSpecification.isArchivedSpec(isArchived)
                .and(LabelSpecification.likeSpec(name))
                .and(LabelSpecification.sortSpec(sort)))
                .build());
