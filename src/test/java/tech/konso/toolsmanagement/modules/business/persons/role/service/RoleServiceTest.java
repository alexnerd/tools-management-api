...
public class RoleServiceTest {
    ...
    public void findAll_should_find_all_not_archived_roles_test() {
        ...
        Specification<Role> spec = AbstractSpecification.specBuilder(RoleSpecification.isArchivedSpec(false)).build();
    ...
    public void findAll_should_find_all_archived_roles_test() {
        ...
        Specification<Role> spec = AbstractSpecification.specBuilder(RoleSpecification.isArchivedSpec(true)).build();
    ...
    public void findAll_should_find_by_name_roles_test() {
        ...
        Specification<Role> spec = AbstractSpecification.specBuilder(RoleSpecification.likeSpec(likeName)).build();
    ...
    public void findAll_should_sort_asc_by_name_roles_test() {
        ...
        Specification<Role> spec = AbstractSpecification.specBuilder(RoleSpecification.sortSpec("name,asc")).build();
    ...
    public void findAll_should_sort_desc_by_name_roles_test() {
        ...
        Specification<Role> spec = AbstractSpecification.specBuilder(RoleSpecification.sortSpec("name,desc")).build();
    ...
    public void findAll_should_sort_asc_by_created_date_roles_test() {
        ...
        Specification<Role> spec = AbstractSpecification.specBuilder(RoleSpecification.sortSpec("createdat,asc")).build();
    ...
    public void findAll_should_sort_desc_by_created_date_roles_test() {
        ...
        Specification<Role> spec = AbstractSpecification.specBuilder(RoleSpecification.sortSpec("createdat,desc")).build();
    ...
    public void findAll_with_null_filter_should_sort_by_default_desc_by_created_date_roles_test() {
        List<String> roleNames = jdbcTemplate.queryForList("SELECT name FROM persons_role ORDER BY created_at DESC", String.class);
        Specification<Role> spec = AbstractSpecification.specBuilder(RoleSpecification.sortSpec(null)).build();
    ...
    public void findAll_with_blank_filter_should_sort_by_default_desc_by_created_date_roles_test() {
        List<String> roleNames = jdbcTemplate.queryForList("SELECT name FROM persons_role ORDER BY created_at DESC", String.class);
        Specification<Role> spec = AbstractSpecification.specBuilder(RoleSpecification.sortSpec(" ")).build();
    ...
    public void findAll_with_unsupported_filter_should_sort_by_default_desc_by_created_date_roles_test() {
        List<String> roleNames = jdbcTemplate.queryForList("SELECT name FROM persons_role ORDER BY created_at DESC", String.class);
        Specification<Role> spec = AbstractSpecification.specBuilder(RoleSpecification.sortSpec("unsupported_filter")).build();
