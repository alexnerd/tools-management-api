...
import static tech.konso.toolsmanagement.modules.business.tools.label.persistence.specification.LabelSpecification.*;
...
public class LabelServiceTest {
    ...
    public void save_should_not_save_if_label_name_already_exists_test() {
        ...
        Long count = jdbcTemplate.queryForObject("SELECT count(*) FROM tools_label WHERE name = '" + labelName + "'", Long.class);
    ...
    public void save_should_not_save_if_label_name_is_null_exists_test() {
        ...
        Long count = jdbcTemplate.queryForObject("SELECT count(*) FROM tools_label WHERE name IS NULL", Long.class);
    ...
    public void findAll_should_find_all_not_archived_labels_test() {
        long countNotArchived = jdbcTemplate.queryForObject("SELECT count(*) FROM tools_label WHERE is_archived IS FALSE", Long.class);
    ...
    public void findAll_should_find_all_archived_labels_test() {
        long countNotArchived = jdbcTemplate.queryForObject("SELECT count(*) FROM tools_label WHERE is_archived IS TRUE", Long.class);
    ...
    public void findAll_should_find_by_name_labels_test() {
        ...
        long countNotArchived = jdbcTemplate.queryForObject("SELECT count(*) FROM tools_label WHERE LOWER (name) LIKE '%" + likeName + "%'", Long.class);
    ...
    public void findAll_should_sort_asc_by_name_labels_test() {
        List<String> labelNames = jdbcTemplate.queryForList("SELECT name FROM tools_label ORDER BY name ASC", String.class);
    ...
    public void findAll_should_sort_desc_by_name_labels_test() {
        List<String> labelNames = jdbcTemplate.queryForList("SELECT name FROM tools_label ORDER BY name DESC", String.class);
    ...
    public void findAll_should_sort_asc_by_created_date_labels_test() {
        List<String> labelNames = jdbcTemplate.queryForList("SELECT name FROM tools_label ORDER BY created_at ASC", String.class);
    ...
    public void findAll_should_sort_desc_by_created_date_labels_test() {
        List<String> labelNames = jdbcTemplate.queryForList("SELECT name FROM tools_label ORDER BY created_at DESC", String.class);
