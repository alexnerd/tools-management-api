package tech.konso.toolsmanagement.modules.business.tools.label.controller;
...
import tech.konso.toolsmanagement.modules.business.tools.label.controller.dto.LabelFilterResponse;
...
public class LabelControllerTest extends AbstractControllerTest {
    ...
    class FindAllTests {
        ...
        public void findAll_should_return_labels_without_filters_test() throws Exception {
            long count = jdbcTemplate.queryForObject("SELECT count(*) FROM tools_label WHERE is_archived IS FALSE", Long.class);
        ...
        public void findAll_should_filter_archived_labels_test() throws Exception {
            long count = jdbcTemplate.queryForObject("SELECT count(*) FROM tools_label WHERE is_archived IS TRUE", Long.class);
        ...
        public void findAll_should_filter_full_name_labels_test() throws Exception {
            ...
            long count = jdbcTemplate.queryForObject("SELECT count(*) FROM tools_label WHERE name = '" + labelName + "' AND is_archived IS FALSE", Long.class);
        ...
        public void findAll_should_filter_like_name_labels_test() throws Exception {
            jdbcTemplate.update("INSERT INTO tools_label (name) VALUES ('Important')");
            jdbcTemplate.update("INSERT INTO tools_label (name) VALUES ('DDLABEDDD')");
            String labelName = "lab";
            long count = jdbcTemplate.queryForObject("SELECT count(*) FROM tools_label WHERE LOWER (name) LIKE '%" + labelName + "%' AND is_archived IS FALSE", Long.class);
            String tail = "?page=1&size=20&name=" + labelName;
        ...
        public void findAll_should_sort_by_name_asc_labels_test() throws Exception {
            List<String> labelNames = jdbcTemplate.queryForList("SELECT name FROM tools_label WHERE is_archived IS FALSE ORDER BY name ASC", String.class);
        ...
        public void findAll_should_sort_by_name_desc_labels_test() throws Exception {
            List<String> labelNames = jdbcTemplate.queryForList("SELECT name FROM tools_label WHERE is_archived IS FALSE ORDER BY name DESC", String.class);
        ...
        public void findAll_should_sort_by_create_date_asc_labels_test() throws Exception {
            List<String> labelNames = jdbcTemplate.queryForList("SELECT name FROM tools_label WHERE is_archived IS FALSE ORDER BY created_at ASC", String.class);
        ...
        public void findAll_should_sort_by_create_date_desc_labels_test() throws Exception {
            List<String> labelNames = jdbcTemplate.queryForList("SELECT name FROM tools_label WHERE is_archived IS FALSE ORDER BY created_at DESC", String.class);
    ...
    class UpdateTests {
        ...
        public void update_should_update_label_name_test() throws Exception {
            ...
            String newLabelName = jdbcTemplate.queryForObject("SELECT name FROM tools_label WHERE label_id = " + labelId + " AND is_archived IS FALSE", String.class);
    ...
    class SaveTests {
        ...
        public void save_should_save_new_label_test() throws Exception {
            ...
            Long countSavedLabels = jdbcTemplate.queryForObject("SELECT count(*) FROM tools_label WHERE name = '" + labelName + "' AND is_archived IS FALSE", Long.class);
